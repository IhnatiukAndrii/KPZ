# Завдання 5: Спостерігач (Observer)

Цей проєкт демонструє використання патернів для роботи з ієрархічною структурою `Light HTML DOM` та реалізації механізму відправки та підписки на події вузлів (спостерігач).
